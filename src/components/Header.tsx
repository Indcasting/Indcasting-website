...
function ContrastIcon({ size = 16 }: { size?: number }) {
  return (
    ...
    >
      ...
      <path
        d="M8 1.75 A6.25 6.25 0 0 1 8 14.25 Z"
        fill="currentColor"
      />
    </svg>
  );
                ...
                {profileOpen && (
                  <div className="ic-dropdown">
                    ...
                    <div className="ic-dd-header">
                      <div className="ic-dd-name">
                        {displayUser.name}
                      </div>

                      <div className="ic-dd-role">
                        {displayUser.role}
                      </div>
                    </div>
